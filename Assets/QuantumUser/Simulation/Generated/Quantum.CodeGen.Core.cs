...
namespace Quantum {
  ...
  public enum RotationLineWiner : int {
    Vertical,
    Horizontal,
    DiagonalRight,
    DiagonalLeft,
  ...
  public unsafe partial struct Input {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + xBoard.GetHashCode();
        hash = hash * 31 + yBoard.GetHashCode();
        hash = hash * 31 + Value.GetHashCode();
        hash = hash * 31 + OnCreateProtptype.GetHashCode();
        hash = hash * 31 + CreateProtoype.GetHashCode();
        hash = hash * 31 + AddBoard.GetHashCode();
        hash = hash * 31 + NewGame.GetHashCode();
        hash = hash * 31 + StartGame.GetHashCode();
        hash = hash * 31 + InitGame.GetHashCode();
        hash = hash * 31 + PositionCreatePrototype.GetHashCode();
        hash = hash * 31 + PosArray.GetHashCode();
        return hash;
      }
    }
    ...
    public Boolean IsDown(InputButtons button) {
      switch (button) {
        ...
        case InputButtons.OnCreateProtptype: return OnCreateProtptype.IsDown;
        case InputButtons.StartGame: return StartGame.IsDown;
        case InputButtons.InitGame: return InitGame.IsDown;
    ...
    public Boolean WasPressed(InputButtons button) {
      switch (button) {
        ...
        case InputButtons.OnCreateProtptype: return OnCreateProtptype.WasPressed;
        case InputButtons.StartGame: return StartGame.WasPressed;
        case InputButtons.InitGame: return InitGame.WasPressed;
        default: return false;
      }
    }
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        var p = (Input*)ptr;
        serializer.Stream.Serialize(&p->PosArray);
        serializer.Stream.Serialize(&p->Value);
        serializer.Stream.Serialize(&p->xBoard);
        serializer.Stream.Serialize(&p->yBoard);
        QBoolean.Serialize(&p->AddBoard, serializer);
        QBoolean.Serialize(&p->CreateProtoype, serializer);
        QBoolean.Serialize(&p->NewGame, serializer);
        FP.Serialize(&p->x, serializer);
        FP.Serialize(&p->y, serializer);
        Button.Serialize(&p->Fire, serializer);
        Button.Serialize(&p->InitGame, serializer);
        Button.Serialize(&p->Left, serializer);
        Button.Serialize(&p->OnCreateProtptype, serializer);
        Button.Serialize(&p->Right, serializer);
        Button.Serialize(&p->StartGame, serializer);
        Button.Serialize(&p->Up, serializer);
        FPVector2.Serialize(&p->PositionCreatePrototype, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct _globals_ {
    ...
    [FieldOffset(1516)]
    public QBoolean isReset;
    [FieldOffset(1512)]
    public QBoolean isInitGame;
    [FieldOffset(1488)]
    public Int32 rotation;
    [FieldOffset(1504)]
    public Int32 winIndex;
    [FieldOffset(1500)]
    public Int32 valueWiner;
    [FieldOffset(1496)]
    public Int32 scoreCross;
    [FieldOffset(1492)]
    public Int32 scoreCircle;
    [FieldOffset(1520)]
    public QBoolean isStartGameList;
    [FieldOffset(1528)]
    [FramePrinter.FixedArrayAttribute(typeof(EntityRef), 4)]
    private fixed Byte _playerArray_[32];
    [FieldOffset(1524)]
    ...
    public FixedArray<EntityRef> playerArray {
      get {
        fixed (byte* p = _playerArray_) { return new FixedArray<EntityRef>(p, 8, 4); }
      }
    }
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + (Int32)localPlayerType;
        hash = hash * 31 + isReset.GetHashCode();
        hash = hash * 31 + isInitGame.GetHashCode();
        hash = hash * 31 + rotation.GetHashCode();
        hash = hash * 31 + winIndex.GetHashCode();
        hash = hash * 31 + valueWiner.GetHashCode();
        hash = hash * 31 + scoreCross.GetHashCode();
        hash = hash * 31 + scoreCircle.GetHashCode();
        hash = hash * 31 + isStartGameList.GetHashCode();
    ...
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->scoreCircle);
        serializer.Stream.Serialize(&p->scoreCross);
        serializer.Stream.Serialize(&p->valueWiner);
        serializer.Stream.Serialize(&p->winIndex);
        serializer.Stream.Serialize((Int32*)&p->localPlayerType);
        QBoolean.Serialize(&p->isInitGame, serializer);
        QBoolean.Serialize(&p->isReset, serializer);
        QBoolean.Serialize(&p->isStartGameList, serializer);
        QList.Serialize(&p->playerList, serializer, Statics.SerializeEntityRef);
        FixedArray.Serialize(p->playerArray, serializer, Statics.SerializeEntityRef);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct GameViewInfo : Quantum.IComponent {
    public const Int32 SIZE = 8;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(0)]
    public EntityRef playerLocal;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 6163;
        hash = hash * 31 + playerLocal.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (GameViewInfo*)ptr;
        EntityRef.Serialize(&p->playerLocal, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct LineWiner : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(12)]
    public RotationLineWiner direction;
    [FieldOffset(0)]
    public Int32 rotation;
    [FieldOffset(4)]
    [FreeOnComponentRemoved()]
    ...
    [FieldOffset(8)]
    [FreeOnComponentRemoved()]
    public QListPtr<Int32> valueList;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 4021;
        hash = hash * 31 + (Int32)direction;
        hash = hash * 31 + rotation.GetHashCode();
        hash = hash * 31 + PlayerList.GetHashCode();
        hash = hash * 31 + valueList.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      if (PlayerList != default) f.FreeList(ref PlayerList);
      if (valueList != default) f.FreeList(ref valueList);
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.LineWiner*)ptr;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        serializer.Stream.Serialize(&p->rotation);
        QList.Serialize(&p->PlayerList, serializer, Statics.SerializeEntityRef);
        QList.Serialize(&p->valueList, serializer, Statics.SerializeInt32);
        serializer.Stream.Serialize((Int32*)&p->direction);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct PlayerInfo : Quantum.IComponent {
    ...
    public Int32 score;
    [FieldOffset(96)]
    public EntityRef gameManager;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 13049;
        hash = hash * 31 + PlayerRef.GetHashCode();
        hash = hash * 31 + CurrentPlayerRef.GetHashCode();
        hash = hash * 31 + OrtherPlayerRef.GetHashCode();
        hash = hash * 31 + Cricle.GetHashCode();
        hash = hash * 31 + Cross.GetHashCode();
        hash = hash * 31 + LineWiner.GetHashCode();
        hash = hash * 31 + (Int32)PlayerType;
        hash = hash * 31 + ValueBoard.GetHashCode();
        fixed (Int32* p = Value) hash = hash * 31 + HashCodeUtils.GetArrayHashCode(p, 9);
        hash = hash * 31 + isPlaying.GetHashCode();
        hash = hash * 31 + isResetGame.GetHashCode();
        hash = hash * 31 + score.GetHashCode();
        hash = hash * 31 + gameManager.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (PlayerInfo*)ptr;
        serializer.Stream.SerializeBuffer(&p->Value[0], 9);
        serializer.Stream.Serialize(&p->ValueBoard);
        serializer.Stream.Serialize(&p->score);
        PlayerRef.Serialize(&p->CurrentPlayerRef, serializer);
        PlayerRef.Serialize(&p->OrtherPlayerRef, serializer);
        PlayerRef.Serialize(&p->PlayerRef, serializer);
        serializer.Stream.Serialize((Int32*)&p->PlayerType);
        QBoolean.Serialize(&p->isPlaying, serializer);
        QBoolean.Serialize(&p->isResetGame, serializer);
        AssetRef.Serialize(&p->Cricle, serializer);
        AssetRef.Serialize(&p->Cross, serializer);
        AssetRef.Serialize(&p->LineWiner, serializer);
        EntityRef.Serialize(&p->gameManager, serializer);
    }
  }
  ...
  public unsafe partial interface ISignalOnPlayerWin : ISignal {
    void OnPlayerWin(Frame f);
  }
  public unsafe partial interface ISignalOnPlayerResetGame : ISignal {
    void OnPlayerResetGame(Frame f);
  }
  public unsafe partial interface ISignalOnPlayerLose : ISignal {
    void OnPlayerLose(Frame f);
  }
  public unsafe partial interface ISignalOnPlayerTie : ISignal {
    void OnPlayerTie(Frame f);
  }
  public unsafe partial interface ISignalOnPlayerMove : ISignal {
    void OnPlayerMove(Frame f, EntityRef gameManager, Int32 value, Int32 pos);
  }
  ...
  public unsafe partial class Frame {
    ...
    private ISignalOnPlayerWin[] _ISignalOnPlayerWinSystems;
    private ISignalOnPlayerResetGame[] _ISignalOnPlayerResetGameSystems;
    private ISignalOnPlayerLose[] _ISignalOnPlayerLoseSystems;
    private ISignalOnPlayerTie[] _ISignalOnPlayerTieSystems;
    private ISignalOnPlayerMove[] _ISignalOnPlayerMoveSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnPlayerWinSystems = BuildSignalsArray<ISignalOnPlayerWin>();
      _ISignalOnPlayerResetGameSystems = BuildSignalsArray<ISignalOnPlayerResetGame>();
      _ISignalOnPlayerLoseSystems = BuildSignalsArray<ISignalOnPlayerLose>();
      _ISignalOnPlayerTieSystems = BuildSignalsArray<ISignalOnPlayerTie>();
      _ISignalOnPlayerMoveSystems = BuildSignalsArray<ISignalOnPlayerMove>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.GameViewInfo>();
      BuildSignalsArrayOnComponentRemoved<Quantum.GameViewInfo>();
      BuildSignalsArrayOnComponentAdded<Quantum.LineWiner>();
      BuildSignalsArrayOnComponentRemoved<Quantum.LineWiner>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->x = input.x;
      i->y = input.y;
      i->xBoard = input.xBoard;
      i->yBoard = input.yBoard;
      i->Value = input.Value;
      i->OnCreateProtptype = i->OnCreateProtptype.Update(this.Number, input.OnCreateProtptype);
      i->CreateProtoype = input.CreateProtoype;
      i->AddBoard = input.AddBoard;
      i->NewGame = input.NewGame;
      i->StartGame = i->StartGame.Update(this.Number, input.StartGame);
      i->InitGame = i->InitGame.Update(this.Number, input.InitGame);
      i->PositionCreatePrototype = input.PositionCreatePrototype;
      i->PosArray = input.PosArray;
    }
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnPlayerWin() {
        var array = _f._ISignalOnPlayerWinSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPlayerWin(_f);
      ...
      public void OnPlayerResetGame() {
        var array = _f._ISignalOnPlayerResetGameSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPlayerResetGame(_f);
          }
        }
      }
      public void OnPlayerLose() {
        var array = _f._ISignalOnPlayerLoseSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPlayerLose(_f);
      ...
      public void OnPlayerTie() {
        var array = _f._ISignalOnPlayerTieSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPlayerTie(_f);
      ...
      public void OnPlayerMove(EntityRef gameManager, Int32 value, Int32 pos) {
        var array = _f._ISignalOnPlayerMoveSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnPlayerMove(_f, gameManager, value, pos);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.GameViewInfo), Quantum.GameViewInfo.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.LineWiner), Quantum.LineWiner.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.PlayerType), 4);
      ...
      typeRegistry.Register(typeof(Quantum.RotationLineWiner), 4);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 9)
        ...
        .Add<Quantum.GameViewInfo>(Quantum.GameViewInfo.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.LineWiner>(Quantum.LineWiner.Serialize, null, Quantum.LineWiner.OnRemoved, ComponentFlags.None)
    ...
    public static void EnsureNotStrippedGen() {
      ...
      FramePrinter.EnsurePrimitiveNotStripped<Quantum.RotationLineWiner>();
    }
  }
}
